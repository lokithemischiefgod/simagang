        ...
        <div class="space-y-6 w-full max-w-xl">
            ...
            <div class="bg-white shadow rounded-xl p-6">
                <form method="POST" action="{{ route('superadmin.admins.store') }}" class="space-y-4">
                    ...
                    <div class="pt-2">
                        <button type="submit"
                                class="w-full flex justify-center items-center px-4 py-2.5 rounded-lg text-sm font-semibold bg-lintasarta-blue text-white hover:bg-lintasarta-navy transition">
                            Simpan Admin
                        </button>
                    </div>
                </form>
